...
const file_proto_log_proto_rawDesc = "" +
	"\n" +
	"\x0fproto/log.proto\x12\flogcollector\"I\n" +
	"\n" +
	"LogRequest\x12!\n" +
	...
	"\n" +
	"LogService\x12>\n" +
	"\aSendLog\x12\x18.logcollector.LogRequest\x1a\x19.logcollector.LogResponseB\x0fZ\r./proto;protob\x06proto3"
...
var file_proto_log_proto_goTypes = []any{
	(*LogRequest)(nil),  // 0: logcollector.LogRequest
	(*LogResponse)(nil), // 1: logcollector.LogResponse
}
var file_proto_log_proto_depIdxs = []int32{
	0, // 0: logcollector.LogService.SendLog:input_type -> logcollector.LogRequest
	1, // 1: logcollector.LogService.SendLog:output_type -> logcollector.LogResponse
